	                ...
	                <div class="widget-advanced">
	                    ...
	                    <div class="widget-header text-center themed-background-dark">
	                        ...
	                        <h3 class="widget-content-light">
	                            <a href="page_ready_elearning_course_lessons.php"><?= $courseAPI->info['name'] ?></a><br>
	                            ...
	                            <tbody>
	                                ...
	                                <tr>
	                                    ...
	                                    <td class="text-right">
	                                    	...
	                                    	<a href="javascript:void(0)" class="label label-<?= ($assignment['status'] == "draft") ? "warning" : "primary" ?>"><?= $assignment['status'] ?></a>
	                                    </td>
	                                </tr>
	                                <?php
	                                endforeach;
			...
			<div class="col-md-4">
			    ...
			    <div class="block">
			        ...
			        <div class="block-section">
			            <a href="assignment.new.php?course_id=<?= $courseAPI->info['course_id']  ?>" class="btn btn-lg btn-primary btn-block"><i class="fa fa-plus"></i> New Assignment</a>
			        </div>			        
			        <!-- END About Content -->
			    </div>
			    <!-- END About Block -->						    
