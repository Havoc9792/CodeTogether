...
class School{
	...
	public function get($school_id = null, $json = true){
		global $db;
		
		$user_id = User::authService()['user_id'];		
		$db->join("school_teacher ST", "ST.school_id = S.school_id", "LEFT");		
		$db->where('ST.teacher_id', $user_id);	
		$db->orderBy("name", "asc");	
		$schools = $db->get("school S");
		$data = array();
		foreach($schools as $school){
			$school['country_name'] = $this->country_code_to_country($school['country']);
			$data[] = $school;
		}
		if($json){
